...
const cardClass = "shadow-none rounded-2xl border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900 sm:p-6";

function StatusTile({ title, badge, tone, text }: { title: string; badge: string; tone: StatusTone; text: string }) {
	return (
		<div className="min-w-0 rounded-2xl border border-zinc-200/70 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
		...
		<div className="space-y-6">
			...
			<Card className={cardClass}>
				<div className="flex flex-wrap items-baseline justify-between gap-2">
					<h2 className="text-sm font-semibold text-zinc-950 dark:text-zinc-50">Hoy saldrían</h2>
			...
			<Card className={cardClass}>
				<h2 className="text-sm font-semibold text-zinc-950 dark:text-zinc-50">Plantillas</h2>
			...
			<Card className={cardClass}>
				<h2 className="text-sm font-semibold text-zinc-950 dark:text-zinc-50">Últimos envíos</h2>
				{!config.ledgerReady ? (
