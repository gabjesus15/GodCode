...
export function LandingInstagramIcon({ size = 20, className, ...props }: IconProps) {
	return (
		<svg
			width={size}
			height={size}
...
export function LandingLinkedInIcon({ size = 20, className, ...props }: IconProps) {
	return (
		<svg
			width={size}
			height={size}
...
export function LandingWhatsAppIcon({ size = 20, className, ...props }: IconProps) {
	return (
		<svg
			width={size}
			height={size}
...
export function LandingMailIcon({ size = 20, className, ...props }: IconProps) {
	return (
		<svg
			width={size}
			height={size}
