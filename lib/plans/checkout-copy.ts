...
const COPY: Record<CheckoutLocale, CheckoutCopy> = {
  es: {
    success: {
      ...
      leadPaid: "Ya registramos el pago y ahora puedes entrar a tu cuenta. En tu primera compra recibes +1 mes gratis sobre los meses que pagaste.",
  ...
  en: {
    success: {
      ...
      leadPaid: "We already recorded the payment. You can now open your account. On your first purchase you get +1 free month on top of the months you paid for.",
  ...
  pt: {
    success: {
      ...
      leadPaid: "Já registramos o pagamento. Agora você pode entrar na sua conta. Na primeira compra você recebe +1 mês grátis sobre os meses pagos.",
  ...
  fr: {
    success: {
      ...
      leadPaid: "Le paiement a bien été enregistré. Vous pouvez maintenant ouvrir votre compte. Lors de votre premier achat, vous recevez +1 mois gratuit en plus des mois payés.",
  ...
  de: {
    success: {
      ...
      leadPaid: "Die Zahlung wurde bereits erfasst. Sie können jetzt Ihr Konto öffnen. Beim ersten Kauf erhalten Sie +1 Monat gratis zusätzlich zu den bezahlten Monaten.",
  ...
  it: {
    success: {
      ...
      leadPaid: "Abbiamo già registrato il pagamento. Ora puoi aprire il tuo account. Al primo acquisto ricevi +1 mese gratis oltre ai mesi pagati.",
