...
export function resolveThemeColors(theme: Partial<StoreThemeConfig>): ResolvedThemeColors {
	...
	const backgroundImageUrl = sanitizeThemeImageUrl(theme.backgroundImageUrl) || "/tenant/menu-pattern.webp";
